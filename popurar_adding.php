...
<header>
   ...
   <section class="popular-add">
    
      <form action="" method="post" enctype="multipart/form-data" name="form" class="field" id="new_field">
          <legend class="legend">add movie to popular movie list</legend>
          <div id="div"></div>
         
            <br><br>
            <div class="error"><div class="remove" id="remove">x</div></div>
      <div  class="submit12" >
      <input type="submit" name="submit" id="submit12" >
      </div>
      <div class="selected"><span id="selected_out"></span><span> / 10</span><span id="selectedoutword"></span></div>
      </form>
   </section>
