...
<body>
 ...
 <?php
$user=$_GET['user'];
$conn=mysqli_query($con,"SELECT*FROM `popular`  where `movie_unique_id`={$user}");
...
<div class="download">
    ...
    <div class="download-links">
        <a href="files/movie/<?php echo $row['movie_url'] ?>" download>480p</a>
        <a href="files/movie/<?php echo $row['movie_url']?>" download>7200p</a>
        <a href="files/movie/<?php echo $row['movie_url']?>" download>1080p</a>
    </div>
</div>
<?php 
    }
